...
export function Footer() {
  return (
    <footer className="relative mt-24 overflow-hidden bg-navy-900 text-sky-100">
      ...
      <div className="relative border-t border-white/10">
        <div className="mx-auto flex w-full max-w-6xl flex-col gap-2 px-5 py-5 text-xs text-sky-200/50 sm:flex-row sm:items-center sm:justify-between sm:px-8">
